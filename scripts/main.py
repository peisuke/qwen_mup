...
def lr_check(mup,
    ...
    models = {f'{width}': {
        'model': gen(width, standparam=not mup),
        'data': gen_data(seq_len),
        'loader': gen_loader(batch_size),
    }}
    ...
    filepath = os.path.join(output_dir, 'lr.csv')
...
if __name__ == '__main__':
    ...
    exp_width = config['model']['exp_width']
